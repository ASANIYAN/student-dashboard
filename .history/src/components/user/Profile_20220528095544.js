...
const Profile = () => {
    ...
    <div className="w-full">
        ...
        <div className="container">
            ...
            <div className="mt-10 block p-6 w-fit rounded-lg border shadow-md text-black bg-white hover:bg-green  hover:text-white mx-auto">
            <h2 className="mb-2 text-3xl font-normal tracking-tight">User:</h2>
            <h3 className="font-normal text-2xl break-words w-full">
                {
                    currentUser.email
                }
            </h3>
