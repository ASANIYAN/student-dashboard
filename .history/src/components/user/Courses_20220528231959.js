...
const Courses = () => {
    ...
    return (
        ...
        <div className="container">
            ...
            <h1 className="text-4xl text-center" onClick={handleCourseClick}>
                Courses
            </h1>
            {
                    course.map((data) => {
                        return <div key={data.id} className="cursor-pointer mt-10 block p-6 max-w-sm rounded-lg border shadow-md text-black bg-white hover:bg-green hover:text-white mx-auto h-28">
