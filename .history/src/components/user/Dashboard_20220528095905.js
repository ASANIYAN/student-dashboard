    ...
    return (
        <div className="w-full">
            ...
            <div className="container mt-10">
                <div className="flex flex-col justify-around bg-white rounded-lg border border-white shadow-md md:flex-row w-fit mx-auto">
                    <div className="pt-20">
                        {
                        ...
                        <p className="text-4xl text-center break-words w-full whitespace-normal truncate">
                            {
                                currentUser.email
                            }
                        </p>
