...
const Courses = () => {
    ...
    return (
        ...
        <div className="container">
            ...
            {
                    course.map((data) => (
                        <div key={data.id} onClick={handleCourseClick} className="cursor-pointer mt-10 block p-6 max-w-sm rounded-lg border shadow-md text-black bg-white hover:bg-green hover:text-white mx-auto h-28">
                            <h2 key={data.id} ref={courseRef} className="mb-2 text-3xl font-normal tracking-tight">
                                {
                                    data.name
                                }
                            </h2>
