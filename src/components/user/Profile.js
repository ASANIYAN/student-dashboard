...
const Profile = () => {
    ...
    <div className="w-full">
        ...
        <div className="container">
            ...
            <div class="mt-10 block p-6 max-w-sm rounded-lg border shadow-md text-black bg-white hover:bg-green  hover:text-white mx-auto">
            <h5 class="mb-2 text-2xl font-normal tracking-tight">User:
            <span className="pl-4">
                {
                    currentUser.email
                }
