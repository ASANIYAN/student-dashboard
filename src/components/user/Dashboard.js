...
import students from "../landing/assets/img/students.svg";
        ...
        <div className="w-full">
            ...
            <aside className={`w-64 absolute ${open ? 'left-0' : '-left-64'} border-2 border-green h-screen transition-all duration-200`} aria-label="Sidebar">
                <div className="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-green h-full">
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link to='/' className="flex items-center p-2 text-base font-normal text-white rounded-lg  hover:bg-white hover:text-green">
                        ...
                        <li>
                            <Link to='/profile' className="flex items-center p-2 text-base font-normal text-white rounded-lg  hover:bg-white hover:text-green">
                        ...
                        <li>
                            ...
                            className="flex items-center p-2 text-base font-normal text-white rounded-lg  hover:bg-white hover:text-green">
            ...
            <div className="container mt-10">
                ...
                <div className="mt-10 md:mt-0">
                    <h2>
                        <img src={students} width='400' height='400' alt="" />
                    </h2>
                </div>
                </div>
            </div>
